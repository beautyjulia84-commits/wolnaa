...
export default function WheelTerms() {
  return <main className="mx-auto min-h-screen max-w-3xl px-6 py-16 text-zinc-300">
    ...
    <div className="space-y-5 text-sm leading-7">
      ...
      <p>Gewinnchancen: 5 % Rabatt mit 15 % Wahrscheinlichkeit; 10 % mit 20 %; 15 % mit 25 %; 20 % mit 20 %; 25 % mit 20 %. Die Zufallsauswahl erfolgt auf dem Server. Die gleich großen grafischen Radfelder stellen nicht die unterschiedlichen Wahrscheinlichkeiten dar.</p>
