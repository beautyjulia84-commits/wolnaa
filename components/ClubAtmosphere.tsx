...
export default function ClubAtmosphere({lang}:{lang:'de'|'ru'}) {
  ...
  return <section ref={section} className="relative isolate min-h-[540px] overflow-hidden border-y border-[#d6b36a]/20 bg-zinc-950 md:min-h-[620px]">
    <div ref={background} aria-hidden="true" className="pointer-events-none absolute inset-x-0 top-0 h-[100lvh] min-h-[620px] bg-cover bg-center will-change-transform" style={{backgroundImage:'url(/club-atmosphere-stock.jpg)'}} />
