...
export default function DiscountWheelPopup() {
  ...
  return <>
    <button onClick={() => setOpen(true)} className="fixed right-4 top-28 z-40 rounded-full border border-[#d6b36a]/50 bg-black/90 px-4 py-2 text-xs font-semibold text-[#d6b36a] shadow-lg">Nürnberg · bis 25 % gewinnen</button>
